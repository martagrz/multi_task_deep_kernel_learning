...
y2, x2, x2_tst, y2_tst, x2_s, y2_s  = load_dataset(func=func_task_transpose,n=n,x_range=x_range)
...
model = DKL(x,y, sigma_sq=1e-3, learn_rate=1e-4)
try:
...
plt.ylabel('y')
plt.title("Dataset 1")
plt.savefig('../figures/toy-data-mt-transpose1.png')
plt.show()
...
plt.ylabel('y')
plt.title("Dataset 2")
plt.savefig('../figures/toy-data-mt-transpose2.png')
plt.show()
...
plt.savefig('../figures/toy-data-mt-transpose-basis.png')
plt.show()
